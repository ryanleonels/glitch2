...
const SPACE_ENERGY_UPGRADE_COST = [100,100,100,1000,1e5,1e10,1e15,1e25,1e50,1e100,1e200,"1e1000"]
const NUCLEO_UPGRADE_COST = [9e12,6e14,1e17,NaN]
const NORMAL_ENERGY_UPGRADE_COST = [1e8, 5, 10, 1000]
...
function getNormalEnergyTimeMult() {
  ...
  if (game.NEU.includes(3)&&game.normalEnergy.gte(3)) capped = EN(3).times(game.normalEnergy.logBase(3).sqrt()).times(1.15)
  return capped
}
