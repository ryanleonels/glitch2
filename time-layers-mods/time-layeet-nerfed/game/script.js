...
function loop(ms) {
  ...
  overallSpeed=overallSpeed.times(starMile(9)?2+starMile(14):1).times(inGalChal(5)?1:1)
  app.$data.timeLayerMult[2]=EN(starMile(9)?2+starMile(14):1).times(inGalChal(5)?1:1).beautify(2)
  ...
  if (game.spaceless) {
    ...
    game.spaceFoam=game.spaceFoam.max(
      ...
      .times(game.achievement.includes(15)?8:1)
      .times(game.achievement.includes(21)?(1+game.spaceFoam.times(1609/4).log10()):1)
      .times(game.achievement.includes(22)?(1+game.spaceFoam.times(42195/20).log10()):1)
      .times(game.achievement.includes(23)?(1+game.spaceFoam.times(20000).log10()):1)
      .times(game.achievement.includes(24)?(game.timeFoam.pow(0.5)):1)
