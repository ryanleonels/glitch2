...
//saving and loading
function save(){
    try{ window.localStorage.setItem('ordinalPRINGLESsaveBugless', JSON.stringify(data)) }
    catch (e) {
...
function load() {
    let savedata = JSON.parse(window.localStorage.getItem('ordinalPRINGLESsaveBugless'))
...
function deleteSave(){
    window.localStorage.removeItem('ordinalPRINGLESsaveBugless')
    location.reload()
}
