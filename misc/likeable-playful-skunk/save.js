...
function save() {
  localStorage.setItem("inc-tourn-sigma", JSON.stringify(game));
}

function load() {
  if (localStorage.getItem("inc-tourn-sigma")) {
    savegame = JSON.parse(localStorage.getItem("inc-tourn-sigma"));
