...
,v = new Vue({
   ...
   ,computed:{
      ...
      ,AchieveCellEff(){return Math.pow(7.999999999999,this.AchieveCellN)}
      ,AchieveRowEff(){return Math.pow(3.999999999999,this.AchieveRowN)}
      ,AutoPool:()=>[null
      ...
      ,BM0etcMult_Ach(){
         ...
         if(Achievement[0]&8) arr1[0][0]=Times(arr1[0][0],8);
         if(Achievement[3]&32) arr1[0][0]=Times(arr1[0][0],8);
         if(arr1[0][1]&&Achievement[1]&128) arr1[0][1]=Times(arr1[0][1],8);
         if(arr1[0][2]&&Achievement[0]&16) arr1[0][2]=Times(arr1[0][2],8);
         if(arr1[0][3]&&Achievement[1]&16) arr1[0][3]=Times(arr1[0][3],8);
         if(arr1[0][6]&&Achievement[1]&64) arr1[0][6]=Times(arr1[0][6],8);
         if(arr1[1]&&Achievement[2]&32){
            if(arr1[1][0]) arr1[1][0]=Times(arr1[1][0],2);
            if(arr1[1][1]) arr1[1][1]=Times(arr1[1][1],2)
         }
         return arr1
      }
      ,BM0etcMult_Bought(){
...
,Loop = ()=>{
   ...
   var dt=(Date.now()-Time.LastUpdate)*0.001*Math.max(1.05^Math.log10(v.MainNumber+1),1);
