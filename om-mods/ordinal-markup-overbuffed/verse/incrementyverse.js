...
const incrementyverseUpgradeCosts = [EN("1e1100"),EN("1e2200"),EN("e5e5"),EN("ee10"),EN("10^^1000"),EN("10^^^100"),EN("10^^^^^10"),EN("10^^^^^^^^^10"),EN("NaN"),EN("NaN"),EN("NaN"),EN("NaN")]
const ordThreshData = {
...
function getTotalOrbMult() {
  return EN(250+game.fractalUpgrades[2]*0.3).pow(getOrbs()*getOrbEffectMult())
}
