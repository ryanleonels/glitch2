...
let singfunctions = [
  ...
  SF(16, [62], 72, [0,0]),
  SF(0, [63], 73, [0,0]),
  SF(EN(800), [71,72,73], 81, [0,0]),
  SF(EN(15), [81], 91, [0,0]),
  SF(EN(25), [81], 92, [0,0]),
  SF(EN(1e3), [81], 93, [0,0]),
  SF(EN(0), [91], 101, [0,0]),
  SF(EN(50), [92], 102, [0,0]),
  SF(EN("ee2"), [93], 103, [0,0]),
  SF(EN(0), [101], 111, [0,0]),
  SF(EN(40), [102], 112, [0,0]),
  SF(EN(15), [101,103], 113, [0,0]),
  SF(EN(2e3), [102], 114, [0,0]),
  SF(EN("ee4"), [103], 115, [0,0]),
  SF(EN(0), [115], 121, [0,0]),
  SF(EN("10^^5"), [121], 131, [0,0]),
