...
function load() {
  const loadgame = JSON.parse(localStorage.getItem("ordinalMarkupSaveFuniermode"));
...
function save() {
  if (AF === 0) localStorage.setItem("ordinalMarkupSaveFuniermode", JSON.stringify(game));
}
