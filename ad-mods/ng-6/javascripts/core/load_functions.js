...
function updateNGModeMessage(){
        ...
        if (player.galacticSacrifice) {
          if (player.aarexModifications.ngmX>5) ngModeMessages.push('Welcome to NG-6, the nerfed version of NG-5! This is impossible because you are testing. Good luck! This mod is made by 3^3=7.')
          else      if (player.aarexModifications.ngmX>4) ngModeMessages.push('Welcome to NG-5, the nerfed version of NG-4! This is very hardcore because you are stuck in more challenges. You are also stuck in Automated Big Crunches Challenge which is a big impact on this mod. Good luck! This mod is made by Aarex.')
